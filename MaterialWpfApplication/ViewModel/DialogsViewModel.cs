...
using MaterialWpfApplication.DialogWindows;
...
namespace MaterialWpfApplication.ViewModel
{
    public class DialogsViewModel : INotifyPropertyChanged
    {
        ...
        {
            //Sample 4
            OpenSample4DialogCommand = new DelegateCommand(OpenSample4Dialog);
            AcceptSample4DialogCommand = new DelegateCommand(AcceptSample4Dialog);
            CancelSample4DialogCommand = new DelegateCommand(CancelSample4Dialog);
        }

        #region SAMPLE 3

        public DelegateCommand RunDialogCommand => new DelegateCommand(ExecuteRunDialog);

        public DelegateCommand RunExtendedDialogCommand => new DelegateCommand(ExecuteRunExtendedDialog);
        ...
        public DelegateCommand OpenSample4DialogCommand { get; }
        public DelegateCommand AcceptSample4DialogCommand { get; }
        public DelegateCommand CancelSample4DialogCommand { get; }
